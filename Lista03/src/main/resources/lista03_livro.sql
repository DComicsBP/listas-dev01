...
INSERT INTO `livro` VALUES (1,1999,_binary '\0','TITULO 0105');
...
-- Dump completed on 2018-11-02 10:25:02
-- MySQL dump 10.13  Distrib 8.0.12, for Win64 (x86_64)
--
-- Host: localhost    Database: lista03
-- ------------------------------------------------------
...
-- Dump completed on 2018-11-02 10:25:01
-- MySQL dump 10.13  Distrib 8.0.12, for Win64 (x86_64)
--
-- Host: localhost    Database: lista03
-- ------------------------------------------------------
...
CREATE TABLE `bibliotecario` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_5obfy3evcgtgrxdo01fglmmtm` (`email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `editora` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_dupcri2uoymu3gefy4dydd992` (`cnpj`)
...
INSERT INTO `editora` VALUES (1,'nome09','cnpj0100'),(2,'nome06','cnpj0110');
...
-- Dump completed on 2018-11-02 10:25:07
